...
<div class="max-w-3xl mx-auto">
    <div class="glass p-8">
        <h1 class="text-2xl font-bold text-white mb-6">Edit Driver</h1>
        <form method="POST" action="{{ route('drivers.update', $driver) }}" enctype="multipart/form-data" class="space-y-5">
            @csrf
            @method('PUT')
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    <label class="form-label">Name</label>
                    <input type="text" name="name" value="{{ old('name', $driver->name) }}" required class="form-input">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="phone" value="{{ old('phone', $driver->phone) }}" class="form-input">
                </div>
                <div>
