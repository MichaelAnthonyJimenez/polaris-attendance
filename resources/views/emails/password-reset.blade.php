...
<body style="margin:0; padding:0; background:#f1f5f9;">
    <div style="display:none; max-height:0; overflow:hidden; opacity:0; color:transparent;">
        Use this link to reset your {{ config('app.name', 'Polaris Attendance') }} password.
    </div>
                        ...
                        <td style="background:#ffffff; border:1px solid #e2e8f0; border-radius:16px; padding:26px;">
                            ...
                            <div style="font-family:system-ui,-apple-system,Segoe UI,Roboto,Arial,sans-serif; color:#334155; font-size:15px; line-height:1.7;">
                                ...
                                <p style="margin:0 0 14px 0;">
                                    We received a request to reset your {{ config('app.name', 'Polaris Attendance') }} password.
                                    Click the button below to choose a new one.
                                </p>

                                <table role="presentation" cellpadding="0" cellspacing="0" style="margin:16px 0 10px 0;">
                                    <tr>
                                        <td style="background:#0284c7; border-radius:12px;">
                                            <a href="{{ $resetUrl }}"
                                               style="display:inline-block; padding:12px 16px; font-family:system-ui,-apple-system,Segoe UI,Roboto,Arial,sans-serif; font-size:14px; font-weight:800; color:#ffffff; text-decoration:none; border-radius:12px;">
                                                Reset password
                                            </a>
                                        </td>
                                    </tr>
                                ...
                                <div style="margin:14px 0 0 0; padding:12px; background:#f8fafc; border:1px solid #e2e8f0; border-radius:12px;">
                                    <div style="font-weight:800; color:#0f172a; margin:0 0 6px 0;">Having trouble with the button?</div>
                                    <div style="color:#64748b; font-size:13px; line-height:1.6;">
                                        Copy and paste this link into your browser:
                                    </div>
                                    <div style="margin:8px 0 0 0; font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace; font-size:12px; color:#0f172a; word-break:break-all;">
                                        {{ $resetUrl }}
                                    </div>
                                </div>
